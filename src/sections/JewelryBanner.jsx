// components/JewelryBanner.jsx
import React from 'react';
import { ArrowRight, Crown } from 'lucide-react';
import { jewelryBanner } from '../data/jewelryBannerData';
        ...
        <div className="max-w-[1400px] mx-auto px-4 lg:px-6 xl:px-8 w-full">
          <div className="max-w-lg md:max-w-xl">
            ...
            <p className="text-white/70 text-sm sm:text-base md:text-lg mb-5 md:mb-6 max-w-md">
              {jewelryBanner.description}
            </p>

            {/* CTA Button - Gold */}
            <a
              href={jewelryBanner.buttonLink}
