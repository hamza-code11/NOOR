...
const LadiesWearSection = () => {
  ...
  const displayCards = [
    ...ladiesWearProducts.slice(currentIndex),
    ...ladiesWearProducts.slice(0, currentIndex),
    ...ladiesWearProducts.slice(currentIndex),
    ...ladiesWearProducts.slice(0, currentIndex),
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-6 xl:px-8 relative z-10">
        ...
        <div className="flex items-center justify-between mb-6 md:mb-8">
          <div>
            ...
            <p className="text-white/60 text-sm md:text-base">
              Curated collection for the modern woman
            </p>
          </div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mt-6">
            {ladiesWearProducts.map((_, index) => (
              <button
                key={index}
...
export default LadiesWearSection;