// pages/JewelryCollection.jsx
import React from 'react';
import { ArrowLeft } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import JewelryBanner from '../../components/web/Jewelry/JewelryBanner';
import JewelryCategoryCards from '../../components/web/Jewelry/JewelryCategoryCards';
import JewelryNewArrivals from '../../components/web/Jewelry/JewelryNewArrivals';
...
const JewelryCollection = () => {
  ...
  return (
    <div className="min-h-screen bg-primary">
      ...
      <JewelryCategoryCards />

      {/* New Arrivals - 6 per row */}
      <JewelryNewArrivals />
    </div>
  );
};
