// pages/TeensCollection.jsx
import React, { useState, useEffect } from 'react';
import { ArrowLeft, Grid3X3, List } from 'lucide-react';
import { useNavigate, useSearchParams } from 'react-router-dom';
import { teensProducts } from '../../data/collection/teensCollection';

const TeensCollection = () => {
    ...
    const filteredProducts = activeCategory === 'all'
        ? teensProducts
        : teensProducts.filter(p => p.category === activeCategory);
                        ...
                        {categories.map((cat) => (
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    navigate(`/teens-collection?category=${cat.id}`, { replace: true });
                                }}
...
export default TeensCollection;